...
class _WelcomeScreenState extends State<WelcomeScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    final v = StorageService.getSetting(AppConstants.userNameKey, defaultValue: '');
    _name = v is String ? v : '';
  }
                ...
                Align(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _name.isEmpty ? 'NEWSON' : _name.toUpperCase(),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 34,
...
class _SlideToStartState extends State<_SlideToStart> with SingleTickerProviderStateMixin {
  ...
  void _animateTo(double target) {
    final tween = Tween<double>(begin: _progress, end: target).animate(CurvedAnimation(parent: _controller, curve: Curves.easeOut));
    _controller
      ..reset()
      ..forward();
    tween.addListener(() {
          ...
          children: [
            Center(
              child: AnimatedBuilder(
                animation: pulse,
                builder: (context, _) {
                  final offset = 2 + 4 * pulse.value; // subtle drift to the right
                  ...
                  return Row(
                    ...
                    children: [
                      ...
                      Opacity(opacity: opacity1, child: const Icon(Icons.chevron_right, color: Colors.white)),
                      Transform.translate(
                        offset: Offset(offset, 0),
                        child: Opacity(opacity: opacity2, child: const Icon(Icons.chevron_right, color: Colors.white)),
                      ),
                      Transform.translate(
                        offset: Offset(offset * 2, 0),
                        child: Opacity(opacity: opacity3, child: const Icon(Icons.chevron_right, color: Colors.white)),
                      ),
                    ],
                  );
                },
            ...
            Positioned(
              ...
              child: Transform.scale(
                ...
                child: Container(
                  width: knob,
                  height: knob,
                  decoration: BoxDecoration(color: widget.red, shape: BoxShape.circle),
